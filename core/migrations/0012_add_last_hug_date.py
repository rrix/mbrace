...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hugger.last_hug_date'
        db.add_column(u'core_hugger', 'last_hug_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 7, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hugger.last_hug_date'
        db.delete_column(u'core_hugger', 'last_hug_date')
