...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hugger.name'
        db.delete_column(u'core_hugger', 'name')


    def backwards(self, orm):
        # Adding field 'Hugger.name'
        db.add_column(u'core_hugger', 'name',
                      self.gf('django.db.models.fields.CharField')(default='FIXME', max_length=20),
                      keep_default=False)
