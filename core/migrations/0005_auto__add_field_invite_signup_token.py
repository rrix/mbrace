...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invite.signup_token'
        db.add_column(u'core_invite', 'signup_token',
                      self.gf('django.db.models.fields.CharField')(default='invalid', unique=True, max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invite.signup_token'
        db.delete_column(u'core_invite', 'signup_token')
