...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_hugger', 'last_location', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Hugger.last_location'
        db.alter_column(u'core_hugger', 'last_location', self.gf('django.db.models.fields.CharField')(max_length=20))
