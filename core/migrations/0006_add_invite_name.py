...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invite.target_name'
        db.add_column(u'core_invite', 'target_name',
                      self.gf('django.db.models.fields.CharField')(default='INVALID', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invite.target_name'
        db.delete_column(u'core_invite', 'target_name')
    ...
    models = {
        ...
        u'core.invite': {
            ...
            'signup_token': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32'}),
            'target_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'target_name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
