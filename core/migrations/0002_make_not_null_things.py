...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hugger.last_hug_date'
        db.alter_column(u'core_hugger', 'last_hug_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
        ...
        # Changing field 'Hugger.zip_code'
        db.alter_column(u'core_hugger', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Hugger.phone_number'
        db.alter_column(u'core_hugger', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Hugger.last_hug_date'
        db.alter_column(u'core_hugger', 'last_hug_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date.today))

        # Changing field 'Hugger.last_location'
        db.alter_column(u'core_hugger', 'last_location', self.gf('django.db.models.fields.CharField')(default='hi haters', max_length=100))

        # Changing field 'Hugger.zip_code'
        db.alter_column(u'core_hugger', 'zip_code', self.gf('django.db.models.fields.CharField')(default=12345, max_length=5))

        # Changing field 'Hugger.phone_number'
        db.alter_column(u'core_hugger', 'phone_number', self.gf('django.db.models.fields.CharField')(default=6231234567, max_length=20))
    ...
    models = {
        ...
        u'core.hugger': {
            ...
            'last_location': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
